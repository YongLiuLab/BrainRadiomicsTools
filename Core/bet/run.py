...
from bet.data_loading import load_and_preprocess, save_segmentation_nifti
from bet.predict_case import predict_case_3D_net
import imp
from bet.utils import postprocess_prediction, SetNetworkToVal, get_params_fname, maybe_download_parameters
import os
import bet
...
def run_hd_bet(mri_fnames, output_fnames, mode=True, config_file=os.path.join(bet.__path__[0], "config.py"), device='cpu',
               postprocess=False, do_tta=False, keep_mask=False, overwrite=True):
    """
